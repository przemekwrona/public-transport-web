...
import {
    ...
    TimetableEditorComponentMode
} from "./agency/timetable/create-timetable/timetable-editor.component";
...
export const routes: Routes = [
    ...
    {path: 'planner', component: TransportComponent},
    {
        path: 'agency', component: AgencyComponent, resolve: {agencyDetails: agencyDetailsResolver}, children: [
            ...
            {path: 'routes/:routeCode/trips/create', component: TripEditorComponent, resolve: { trip: tripEditorResolver, variants:  tripsResolver}, data: { mode: TripEditorComponentMode.CREATE }},
            {path: 'routes/:routeCode/trips/:tripCode/edit', component: TripEditorComponent,  resolve: { trip: tripEditorResolver }, data: { mode: TripEditorComponentMode.EDIT }},
