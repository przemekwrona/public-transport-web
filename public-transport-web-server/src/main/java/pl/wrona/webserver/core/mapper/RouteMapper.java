        ...
        return Optional.ofNullable(routeEntity)
                .map(routeOptional -> new Route()
                        ...
                        .originTerritory(new TerritoryRoute()
                                ...
                                .lat(originTerritoryOpt.map(TerritorialUnitEntity::getCentroidLat).orElse(null))
                                .lon(originTerritoryOpt.map(TerritorialUnitEntity::getCentroidLat).orElse(null)))
                        .destinationTerritory(new TerritoryRoute()
                                ...
                                .lat(destinationTerritoryOpt.map(TerritorialUnitEntity::getCentroidLat).orElse(null))
                                .lon(destinationTerritoryOpt.map(TerritorialUnitEntity::getCentroidLon).orElse(null)))
