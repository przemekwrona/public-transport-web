...
import pl.wrona.webserver.bussiness.timetable.generator.details.TimetableGeneratorDetailsService;
...
public class TimetableGeneratorController implements TimetableGeneratorApi {
    ...
    private final TimetableGeneratorDetailsService timetableGeneratorDetailsService;
    ...
    @Override
    public ResponseEntity<GetTimetableGeneratorDetailsResponse> findTimetableGeneratorDetails(String agency, TimetableGeneratorId timetableGeneratorId) {
        return ResponseEntity.ok(timetableGeneratorDetailsService.findTimetableGeneratorDetails(agency, timetableGeneratorId));
    }
